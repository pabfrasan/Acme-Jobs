/*
 * AuthenticatedAuditorRequestUpdateService.java
 *
...
@Service
public class AuthenticatedAuditorRequestUpdateService implements AbstractUpdateService<Authenticated, AuditorRequest> {
	...
	public AuditorRequest findOne(final Request<AuditorRequest> request) {
		...
		result = this.repository.findOneRequestAuditorById(userAccountId);
